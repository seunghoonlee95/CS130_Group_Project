  ...
  return (
    <MDBCard className="mb-4">
      ...
      <MDBCardBody>
        <MDBListGroup>
          <MDBListGroupItem>
            <MDBIcon fas icon="envelope-square" style={{margin:"3px"}}/> pbruin@g.ucla.edu.test
          </MDBListGroupItem>
          <MDBListGroupItem>
            <MDBIcon fas icon="phone" style={{margin:"3px"}}/> (097) 234-5678
          </MDBListGroupItem>
          <MDBListGroupItem>
            <MDBIcon fas icon="dove" style={{margin:"3px"}}/> @polar_bruin
          </MDBListGroupItem>
          <MDBListGroupItem>
            <MDBIcon fas icon="globe" style={{margin:"3px"}}/> http://www.polarbruin.com
          </MDBListGroupItem>
        </MDBListGroup>
      </MDBCardBody>
